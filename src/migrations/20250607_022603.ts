...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('editor', 'admin');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_instagram" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_spotify" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_google_calendar" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_instagram" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_spotify" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_google_calendar" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_spotify" ADD CONSTRAINT "pages_blocks_spotify_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_google_calendar" ADD CONSTRAINT "pages_blocks_google_calendar_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_spotify" ADD CONSTRAINT "_pages_v_blocks_spotify_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_google_calendar" ADD CONSTRAINT "_pages_v_blocks_google_calendar_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_instagram_order_idx" ON "pages_blocks_instagram" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_instagram_parent_id_idx" ON "pages_blocks_instagram" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_instagram_path_idx" ON "pages_blocks_instagram" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_youtube_order_idx" ON "pages_blocks_youtube" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_youtube_parent_id_idx" ON "pages_blocks_youtube" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_youtube_path_idx" ON "pages_blocks_youtube" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_spotify_order_idx" ON "pages_blocks_spotify" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_spotify_parent_id_idx" ON "pages_blocks_spotify" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_spotify_path_idx" ON "pages_blocks_spotify" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_google_calendar_order_idx" ON "pages_blocks_google_calendar" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_google_calendar_parent_id_idx" ON "pages_blocks_google_calendar" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_google_calendar_path_idx" ON "pages_blocks_google_calendar" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_instagram_order_idx" ON "_pages_v_blocks_instagram" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_instagram_parent_id_idx" ON "_pages_v_blocks_instagram" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_instagram_path_idx" ON "_pages_v_blocks_instagram" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_youtube_order_idx" ON "_pages_v_blocks_youtube" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_youtube_parent_id_idx" ON "_pages_v_blocks_youtube" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_youtube_path_idx" ON "_pages_v_blocks_youtube" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_spotify_order_idx" ON "_pages_v_blocks_spotify" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_spotify_parent_id_idx" ON "_pages_v_blocks_spotify" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_spotify_path_idx" ON "_pages_v_blocks_spotify" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_google_calendar_order_idx" ON "_pages_v_blocks_google_calendar" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_google_calendar_parent_id_idx" ON "_pages_v_blocks_google_calendar" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_google_calendar_path_idx" ON "_pages_v_blocks_google_calendar" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "users_rels_sites_id_idx" ON "users_rels" USING btree ("sites_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_spotify" CASCADE;
  DROP TABLE "pages_blocks_archive" CASCADE;
  DROP TABLE "pages_blocks_media_block" CASCADE;
  DROP TABLE "pages_blocks_google_calendar" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_spotify" CASCADE;
  DROP TABLE "_pages_v_blocks_archive" CASCADE;
  DROP TABLE "_pages_v_blocks_media_block" CASCADE;
  DROP TABLE "_pages_v_blocks_google_calendar" CASCADE;
